...
事例：mMbccbc输出为3
 */
    public static void main(String[] args) {    // t60 处理逻辑更好
        ...
        int count = 0;
        while (characters.size() != count) {  // 动态 list，依靠 count 来记录是否删除了 list 节点
            count = characters.size();
            for (int i = 0; i < characters.size() - 1; i++) { // characters.size() - 1，确保下一行的判断不会报错
